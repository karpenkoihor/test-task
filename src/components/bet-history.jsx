...
export const BetHistory = () => {
    ...
    const betHistory = useSelector((state) => state.user.history);
    ...
    if (betHistory.length === 0) return <p>Loading bets...</p>;
            ...
            <Container>
                {betHistory.map((bet) => (
                    <div key={bet.id} className="border p-3 my-2">
                        ...
                        <div><small className="text-muted">{formatDate(bet.date)}</small></div>
